...
- `77e770d feat: DAY-070 品質系統完整整合（legendary 召喚 BOSS + 品質光暈 + 受擊特效）`
- `f815e69 feat: DAY-070 品質系統 Client 端整合 + 測試修復`
- `8a6360a chore: auto update progress`
- `f5f8077 docs: API 文件升級到 v1.7（/profile + /profiles 端點 + 稱號訊息類型）`
- `578bed8 feat: DAY-069 玩家個人資料 API（/profile + /profiles 端點）`
- `c9e36e0 feat: DAY-068 稱號系統（Title System）+ KnowHow #131-132`
- `72dbade feat: DAY-067 武器升級系統（Weapon Upgrade System）+ KnowHow #130`
- `574220d feat: DAY-066 週賽系統（Weekly Tournament）+ KnowHow #128-129`
...
**最後 commit 訊息**：
```
feat: DAY-070 品質系統完整整合（legendary 召喚 BOSS + 品質光暈 + 受擊特效）

- protocol.go: TargetKillPayload 加入 Quality 欄位
- game.go: legendary 品質 10% 機率觸發提前 BOSS（legendary_summon 事件）
- TargetManager.gd: 品質光暈/受擊閃光/進場動畫/
```
