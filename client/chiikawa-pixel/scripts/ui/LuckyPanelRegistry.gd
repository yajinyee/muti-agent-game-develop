...
const SIGNAL_TO_PANEL: Dictionary = {
	...
	# DAY-327 新增
	"lucky_golden_pot":       "LuckyGoldenPotPanel",
	...
	# DAY-328 新增
	"lucky_magnetic_attraction": "LuckyMagneticAttractionPanel",
	"lucky_super_chain":         "LuckySuperChainPanel",
	"lucky_holy_pillar":         "LuckyHolyPillarPanel",
	"lucky_time_stop":           "LuckyTimeStopPanel",
	"lucky_cosmic_restart":      "LuckyCosmicRestartPanel",
	# DAY-329 新增
	"lucky_fever_boost_ultimate":  "LuckyFeverBoostUltimatePanel",
	"lucky_rapid_riches_ultimate": "LuckyRapidRichesUltimatePanel",
	...
	# DAY-332 新增
	"lucky_wild_collector":        "LuckyWildCollectorPanel",
	"lucky_lightning_eel_ultra":   "LuckyLightningEelUltraPanel",
	"lucky_domino_chain":          "LuckyDominoChainPanel",
	"lucky_immortal_boss_ultra":   "LuckyImmortalBossUltraPanel",
	"lucky_quad_fusion":           "LuckyQuadFusionPanel",
	# DAY-333 新增
	"lucky_electrical_frame":      "LuckyElectricalFramePanel",
	"lucky_magnetic_respin":       "LuckyMagneticRespinPanel",
	"lucky_fisherman_trail":       "LuckyFishermanTrailPanel",
	"lucky_golden_gills":          "LuckyGoldenGillsPanel",
	"lucky_penta_fusion":          "LuckyPentaFusionPanel",
}
