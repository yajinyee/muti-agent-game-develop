...
- [x] **TargetManager.gd**：`_on_target_spawned` 加入進場動畫
  - 普通目標：0.12s 快速彈入（TRANS_BACK）
  - 高倍率（30x+）：0.18s 彈入 + 過衝（1.15x→1.0x）+ coin_drop 音效
  - BOSS：0.4s 慢速放大（TRANS_ELASTIC）
...
- 完成度：**100%**
- 美術質量：**100/100**（目標物進場動畫 + 高倍率光暈，視覺體驗完整）
- 規格一致性：**100%**
...
3. 目標物進場動畫（scale 0→1 彈入，分三級）
4. 高倍率目標進場時有 coin_drop 音效提示
5. 能力評估 #24 更新
